         ...
         <form  id="defaultSetting">
            ...
            <div class="default_f_section">
              ...
              <input type="text" name="default_lng" id = "default_lng">
               <p>The default Latitude Longitude determines the starting viewpoint on maps when the page loads. You can also modify the Latitude to change where the map centers when you first open it.</p>
            </div>
            <div class="default_f_section">
